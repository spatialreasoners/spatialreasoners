...
class SpiralSamplingEvaluation(FrameVisSamplingEvaluation[SpiralSamplingEvaluationCfg]):
    ...
    def get_spiral_points(self, num_points: int = 1000) -> Float[Tensor, "num_points 3"]:
        ...
        # We use linspace instead of sampling randomly for cleaner visualization
    ...
    def _get_metrics(
        ...
        For example, you can calculate the distance of the sampled points to the closest point on the spiral.
        This is a very simple implementation where we generate some real points and calculate the distance to the closest.
        """
